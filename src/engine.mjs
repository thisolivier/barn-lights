...
const server = http.createServer((req, res) => {
  ...
  if (u.pathname === "/effects.mjs")
    return streamFile(path.join(__dirname, "effects.mjs"), "text/javascript", res);
  if (u.pathname.startsWith("/web/"))
    return streamFile(path.join(__dirname, u.pathname.substring(1)), "text/javascript", res);
